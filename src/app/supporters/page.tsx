    ...
    <>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 relative z-10 w-full min-h-screen">
        ...
        <div className="flex flex-col md:flex-row justify-center items-end gap-4 md:gap-8 mb-24 h-[400px]">
          {/* Rank 2 */}
          {podiumOrder[0] && (
            <div className="flex flex-col items-center w-full md:w-1/3 animate-[float_6s_ease-in-out_infinite_alternate] drop-shadow-2xl order-2 md:order-1 relative z-20">
              <div className="relative mb-4">
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-gray-300 drop-shadow-[0_0_10px_rgba(209,213,219,0.5)]">
                  <Medal size={48} />
                </div>
                <img 
                  src={`https://skins.mcstats.com/body/front/${podiumOrder[0].username}`} 
          ...
          {/* Rank 1 */}
          {podiumOrder[1] && (
            <div className="flex flex-col items-center w-full md:w-1/3 animate-[float_5s_ease-in-out_infinite_alternate] drop-shadow-[0_0_50px_rgba(234,179,8,0.3)] order-1 md:order-2 relative z-30">
              <div className="relative mb-4">
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 text-yellow-400 drop-shadow-[0_0_20px_rgba(234,179,8,0.8)]">
                  <Crown size={64} />
                </div>
                <img 
                  src={`https://skins.mcstats.com/body/front/${podiumOrder[1].username}`} 
          ...
          {/* Rank 3 */}
          {podiumOrder[2] && (
            <div className="flex flex-col items-center w-full md:w-1/3 animate-[float_7s_ease-in-out_infinite_alternate] drop-shadow-xl order-3 md:order-3 relative z-10">
              <div className="relative mb-4">
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-amber-600 drop-shadow-[0_0_10px_rgba(217,119,6,0.5)]">
                  <Medal size={40} />
                </div>
                <img 
                  src={`https://skins.mcstats.com/body/front/${podiumOrder[2].username}`} 
              ...
              <div className="divide-y divide-white/5">
                {rest.map((supporter, idx) => (
                  <div key={supporter.username} className="flex items-center gap-6 p-6 hover:bg-white/5 transition-colors">
                    ...
                    <img 
                      src={`https://skins.mcstats.com/face/${supporter.username}`} 
